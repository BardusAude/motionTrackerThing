...
def log_samples(log_file, queue):
    """
    Does FFT based event detection and plotting.

    :type log_file: String
    :param log_file: Filename of the log file to write data to.
    :type queue: Multiprocessing Queue
    ...
    df = pd.DataFrame.from_dict(imu_data_dict)
...
def main():
    ...
    log_samples(log_file, data_queue)
